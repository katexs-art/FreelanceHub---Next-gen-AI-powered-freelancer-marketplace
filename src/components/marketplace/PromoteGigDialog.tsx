...
export function PromoteGigDialog({ gigId, onPromoted }: { gigId: string; onPromoted?: () => void }) {
  ...
  const promote = async () => {
    ...
    toast.success("Service is now promoted");
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader><DialogTitle>Promote your service</DialogTitle></DialogHeader>
        <p className="text-sm text-foreground-muted">Boost your service to the top of Search & Explore.</p>
