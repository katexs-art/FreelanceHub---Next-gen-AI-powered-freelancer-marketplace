...
export default function Hq() {
  ...
  const { layout, visible, hidden, reorder, toggleVisible, toggleCollapse, addWidget } = useDashboardLayout();
  ...
  const onDragEnd = (e: DragEndEvent) => {
    ...
    // append hidden ids to preserve them in the saved layout
      ...
      <div className="max-w-6xl">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-foreground-muted mt-1">Your headquarters — customize widgets to suit your workflow.</p>
          </div>
