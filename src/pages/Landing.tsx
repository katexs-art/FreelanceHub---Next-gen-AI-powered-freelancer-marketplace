...
const TESTIMONIALS = [
  ...
  { quote: "I've hired on every AI platform. KATEXS is the only one where the AI actually understands the brief. Zero bad-fit pitches, escrow that just works.", name: "Diego Alvarez", title: "CEO, Helix Home Services", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=160&h=160&fit=crop&crop=faces" },
