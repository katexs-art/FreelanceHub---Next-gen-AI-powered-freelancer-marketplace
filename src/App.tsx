...
const SellerDashboard = lazy(() => import("./pages/expert/SellerDashboard"));
const MyGigs = lazy(() => import("./pages/expert/MyGigs"));
const GigEditor = lazy(() => import("./pages/expert/GigEditor"));
...
const CheckoutSuccess = lazy(() => import("./pages/projects/CheckoutSuccess"));
const Checkout = lazy(() => import("./pages/Checkout"));
const OrdersList = lazy(() => import("./pages/projects/OrdersList"));
const OrderWorkspace = lazy(() => import("./pages/projects/OrderWorkspace"));
const LeaveReviewPage = lazy(() => import("./pages/projects/LeaveReviewPage"));
...
const Verification = lazy(() => import("./pages/expert/Verification"));
const BuyerDashboard = lazy(() => import("./pages/partner/BuyerDashboard"));
const Settings = lazy(() => import("./pages/account/Settings"));
const SellerAnalytics = lazy(() => import("./pages/expert/SellerAnalytics"));
